...
InitData.prototype={
    ...
    initResponseSystemTime:function () {
        let now = new Date(),
            year=(now.getYear()-100).toString(16),
            month=now.getMonth().toString(16),
            day=now.getDate().toString(16),
            hours=now.getHours().toString(16),
            minutes=now.getMinutes().toString(16),
            seconds=now.getSeconds().toString(16),
            week=now.getDay().toString(16),
