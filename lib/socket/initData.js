...
InitData.prototype={
    ...
    initTimeConfigData:function (config) {
        let buf = this.initHeader(),
            length=0x00,
            frameId=0x00,
            btnState =JSON.parse(config.btnState),
            btn1,
            btn2,
            btn3,
            btn4,
        ...
        btn1 = parseInt(btn1, 2).toString(16);
        btn2 = parseInt(btn2, 2).toString(16);
        btn3 = parseInt(btn3, 2).toString(16);
        btn4 = parseInt(btn4, 2).toString(16);
        btn5 = parseInt(btn5, 2).toString(16);
        btn6 = parseInt(btn6, 2).toString(16);
        btn7 = parseInt(btn7, 2).toString(16);
        ...
        for(var i = 0; i<buf.length; i++){
            if(buf[i] < 16){
                aa += '0' + buf[i].toString(16) + ' ';
            }else{
                aa += buf[i].toString(16) + ' ';
            }
    ...
    initDayTimeConfigData:function (config) {
        ...
        for(var i=0;i<5;i++){
            switch (i){
                case 0:
                    btn1 = btnState.section1;
                    break;
                case 1:
                    btn2 = btnState.section2;
                    break;
                case 2:
                    btn3 = btnState.section3;
                    break;
                case 3:
                    btn4 = btnState.section4;
                    break;
                case 4:
                    btn5 = btnState.section5;
                    break;
            }
        }
        btn1 = parseInt(btn1, 2).toString(16);
