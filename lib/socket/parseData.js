...
ParseData.prototype={
    ...
    getJson:function (nodeData) {
        ...
        json.voltage_1 = voltage_1 > 2000 ? 0 : Number(voltage_1).toFixed(1);
        let voltage_2 = this.getVoltage_2(buf);
        json.voltage_2 = voltage_2 > 2000 ? 0 : Number(voltage_2).toFixed(1);
        let voltage_3 = this.getVoltage_3(buf);
        json.voltage_3 = voltage_3 > 2000 ? 0 : Number(voltage_3).toFixed(1);

        // logger.info('::::::json.voltage_1::::::json.voltage_2::::::json.voltage_3::::::');
        // logger.info(voltage_1 + ' ' + voltage_2 + ' ' + voltage_3);

        json.electric_1 = Number(this.getElectric_1(buf)).toFixed(1);
        json.electric_2 = Number(this.getElectric_2(buf)).toFixed(1);
        json.electric_3 = Number(this.getElectric_3(buf)).toFixed(1);
